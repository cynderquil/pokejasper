...
enum {
    ...
    NATIONAL_DEX_GRASSSTARTER1,
    NATIONAL_DEX_GRASSSTARTER2,
    NATIONAL_DEX_GRASSSTARTER3,
    NATIONAL_DEX_FIRESTARTER1,
    NATIONAL_DEX_FIRESTARTER2,
    NATIONAL_DEX_FIRESTARTER3,
    NATIONAL_DEX_WATERSTARTER1,
    NATIONAL_DEX_WATERSTARTER2,
    NATIONAL_DEX_WATERSTARTER3,
};

#define KANTO_DEX_COUNT     NATIONAL_DEX_MEW
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_JASPR_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_WATERSTARTER3
