...
PLACEHOLDER_ANIM_SINGLE_FRAME(GrassStarter1);
PLACEHOLDER_ANIM_SINGLE_FRAME(GrassStarter2);
PLACEHOLDER_ANIM_SINGLE_FRAME(GrassStarter3);
#endif //P_FAMILY_GRASSSTARTER

#if P_FAMILY_FIRESTARTER
PLACEHOLDER_ANIM_SINGLE_FRAME(FireStarter1);
PLACEHOLDER_ANIM_SINGLE_FRAME(FireStarter2);
PLACEHOLDER_ANIM_SINGLE_FRAME(FireStarter3);
#endif //P_FAMILY_FIRESTARTER

#if P_FAMILY_WATERSTARTER
PLACEHOLDER_ANIM_SINGLE_FRAME(WaterStarter1);
PLACEHOLDER_ANIM_SINGLE_FRAME(WaterStarter2);
PLACEHOLDER_ANIM_SINGLE_FRAME(WaterStarter3);
...
#endif //P_FAMILY_PECHARUNT
#if P_FAMILY_GRASSSTARTER
SINGLE_ANIMATION(GrassStarter1);
SINGLE_ANIMATION(GrassStarter2);
SINGLE_ANIMATION(GrassStarter3);
#endif //P_FAMILY_GRASSSTARTER
#if P_FAMILY_FIRESTARTER
SINGLE_ANIMATION(FireStarter1);
SINGLE_ANIMATION(FireStarter2);
SINGLE_ANIMATION(FireStarter3);
#endif //P_FAMILY_FIRESTARTER
#if P_FAMILY_WATERSTARTER
SINGLE_ANIMATION(WaterStarter1);
SINGLE_ANIMATION(WaterStarter2);
SINGLE_ANIMATION(WaterStarter3);
#endif //P_FAMILY_WATERSTARTER
